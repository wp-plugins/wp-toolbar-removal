 ...
 * @license GPLv2
 *
 * Completely Disable ToolBar Frontend, Backend, related User Profile Settings, without loosing logout functionality, and Remove Code for minimal memory load with new approach. Work under GPLv2 License.
