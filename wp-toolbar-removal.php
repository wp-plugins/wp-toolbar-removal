...
<?php
	...
	function wptbr_hfl()
		{
			echo "\n<!--Plugin ToolBar Removal 2013.0622-BUGFIX.0526-DEVELOPMENTAL Active - Tag: ".md5(md5("".""))."-->\n";
