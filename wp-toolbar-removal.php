...
function wptbr_spab_init(){add_filter( 'show_wp_pointer_admin_bar', '__return_false' );}
...
function wptbr_ruppoabpc(){echo'<style type="text/css">.show-admin-bar{display:none}</style>';}add_action('admin_print_styles-profile.php','wptbr_ruppoabpc');show_admin_bar(false);
