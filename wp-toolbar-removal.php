...
function wptbr_ruppoabpc(){echo'<style type="text/css">.show-admin-bar{display:none}</style>';}add_action('admin_print_styles-profile.php','wptbr_ruppoabpc');show_admin_bar(false);function wptbr_rsf(){echo'<style type="text/css">html{margin-top:0px !important}* html body{margin-top:0px !important}</style>';}add_filter('wp_head','wptbr_rsf',99);
...
function wptbr_nfo(){echo"\n<!--Plugin ToolBar Removal 2012.0621-BUGFIX.0108-DEVELOPMENTAL Active-->";}add_action('wp_head','wptbr_nfo');add_action('wp_footer','wptbr_nfo');
?>