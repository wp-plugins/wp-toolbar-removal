...
Description: Disable and Remove ToolBar and Admin Bar Code on WordPress 3.1+ to 3.6+ Frontend Backend and related User Personal Options Settings, Completely, for Minimal Memory Load, and DashBoard Speedup, with New Unified Coding Approach, without loosing Logout and Network MultiSite functionality! Also Hide: Frontend 28px and Bump CB; Backend 28px and Node/Group/Links on Top of DashBoard, Admin Menu Shadow Effect, Admin Bar and ToolBar Pointer ToolTips. The first and only Plugin (for now) that really work on WordPress 3.1+ to 3.6+ The configuration of this Plugin is Automattic! Work under GPLv2 or later License. GNU style indentation coding standard compatible. Meet detailed guidelines quality requirements.
