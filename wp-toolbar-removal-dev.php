...
<?php
	...
	function wptbr_hfl()
		{
			echo "\n<!--Plugin WP Toolbar Removal DEV 2014.0827.0400 Build 2014-07-07 Active - Tag ".md5(md5("".""))."-->\n";
	...
	function wp_toolbar_removal_js()

		{
			...
			wp_enqueue_script( 'wp-toolbar-removal-js' , plugins_url( 'wp-toolbar-removal-dev.js' , __FILE__ ) , array( 'admin-bar' , 'common' ) );
	...
	function wp_toolbar_removal_css()

		{
			...
			wp_enqueue_style( 'wp-toolbar-removal-css' , plugins_url( 'wp-toolbar-removal-dev.css' , __FILE__ ) );
