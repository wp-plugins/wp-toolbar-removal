...
1. Unified Coding to run with WordPress 3.1+ to 3.6+
 ...
 * NEW unified coding to run with wordpress 3.1+ to 3.6+
...
== Upgrade Notice ==
= 2013.0624.0361 =
Major Update [CERTIFIED] Disable WordPress Toolbar and Admin Bar and Remove Code Completely on WP 3.1+ to 3.6+ for Minimal Memory Load, and DashBoard Speedup, with new Unified Coding Approach without loosing Logout and Network MultiSite functionality!
